...
info += f"You have watched the video to frame: 100\n"
# info += f"Video FPS: {self.clientInfo['videoStream'].frames_per_second}\n"
info += f"Total frames: 500\n"
info += f"Total duration: 20\n"
info += f"Video Encode: 100\n"
info += f"This message is sent over RTSP at: \n"
info += f"IP Address: 100 | Port: 100\n"
